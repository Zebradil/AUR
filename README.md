...
| [carvel-tools](https://carvel.dev) | 20240904-1 | [link](https://aur.archlinux.org/packages/carvel-tools) | Deprecated: install carvel tools separately |
...
| [kubectl-gke-rapid-bin](https://github.com/kubernetes/kubectl) | v1.30.4-1 | [link](https://aur.archlinux.org/packages/kubectl-gke-rapid-bin) | Kubernetes.io client binary, compatible with the GKE version from the rapid channel |
...
| [kubectl-gke-stable-bin](https://github.com/kubernetes/kubectl) | v1.27.16-1 | [link](https://aur.archlinux.org/packages/kubectl-gke-stable-bin) | Kubernetes.io client binary, compatible with the GKE version from the stable channel |
