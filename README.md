...
| [carvel-tools](https://carvel.dev) | 20250429-1 | [link](https://aur.archlinux.org/packages/carvel-tools) | Deprecated: install carvel tools separately |
...
| [imgpkg](https://carvel.dev/imgpkg) | 0.46.0-1 | [link](https://aur.archlinux.org/packages/imgpkg) | Store application configuration files in Docker/OCI registries |
| [imgpkg-bin](https://carvel.dev/imgpkg) | 0.46.0-1 | [link](https://aur.archlinux.org/packages/imgpkg-bin) | Store application configuration files in Docker/OCI registries |
