...
| [carvel-tools](https://carvel.dev) | 20231117-1 | [link](https://aur.archlinux.org/packages/carvel-tools) | Set of Carvel tools (binaries): imgpkg kapp kbld kctrl kwt vendir ytt |
| [cloudflare-dynamic-dns](https://github.com/zebradil/cloudflare-dynamic-dns) | 2.3.2-10 | [link](https://aur.archlinux.org/packages/cloudflare-dynamic-dns) | Updates AAAA records at Cloudflare according to the current IPv6 address |
...
| [imgpkg](https://carvel.dev/imgpkg) | 0.39.0-1 | [link](https://aur.archlinux.org/packages/imgpkg) | Store application configuration files in Docker/OCI registries |
...
| [xkb-switch-i3](https://github.com/zebradil/xkb-switch-i3) | 2.0.1+i3_5-7 | [link](https://aur.archlinux.org/packages/xkb-switch-i3) | Program that allows to query and change the XKB layout state (with i3wm auto-switch mode) |
