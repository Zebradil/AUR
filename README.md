...
| [kubectl-gke-stable-bin](https://github.com/kubernetes/kubectl) | v1.28.10-1 | [link](https://aur.archlinux.org/packages/kubectl-gke-stable-bin) | Kubernetes.io client binary, compatible with the GKE version from the stable channel |
