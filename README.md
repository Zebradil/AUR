...
| [kctrl](https://carvel.dev/kapp-controller) | 0.50.0-1 | [link](https://aur.archlinux.org/packages/kctrl) | Continuous delivery and package management for Kubernetes. |
...
| [kubectl-gke-stable-bin](https://github.com/kubernetes/kubectl) | v1.27.11-1 | [link](https://aur.archlinux.org/packages/kubectl-gke-stable-bin) | Kubernetes.io client binary, compatible with the GKE version from the stable channel |
